...
const config: DocsThemeConfig = {
  head: (
    <>
      ...
      <meta name="application-name" content="Hawk-JS-DocSite" />
      <link
      ...
      />
      <meta name="apple-mobile-web-app-title" content="Hawk-JS-DocSite" />
      <link
  ...
  useNextSeoProps: () => {
    ...
    const title =
      frontMatter.title + " | Hawk JS API References | OpenSource of Cresteem";
    return {
      title: title,
      nofollow: false,
      noindex: false,
