    ...
    <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-10 flex flex-col justify-center items-center">
      <div className="max-w-xl">
        ...
        <p className="text-gray-600 mt-3 text-center">
          <a href="https://darsan.in/">DARSAN</a> is a software engineer with a
          passion for web development and SEO optimization. With 2 years of
          industry experience and 7 years of programming expertise, he is
          dedicated to creating tools that simplify workflows and enhance
          digital innovation.
        </p>
      </div>
      <div className="mt-12">
