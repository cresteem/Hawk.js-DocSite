      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-10 flex flex-col justify-center items-center">
        <div className="max-w-xl">
          ...
          <p className="text-gray-600 mt-3 text-justify">
            Hawk.js is a project driven by passion and a desire to improve web
          ...
          <p className="text-gray-600 mt-3 text-justify">
            ...
            us continue to drive this mission forward. By sponsoring Hawk.js,
            you&apos;re helping to shape the future of SEO automation and web
            development.
          </p>
          <p className="text-gray-600 mt-3 text-justify">
            We truly appreciate your support in helping Hawk.js reach new
            heights.
          </p>
          ...
          <div className="text-gray-600 pt-4">
            ...
            <p className="text-gray-600 mt-3 text-justify">
              As a sponsor of Hawk.js, you&apos;ll receive exclusive benefits
            ...
            <ul className="py-3 ml-6">
              ...
              <li className="list-disc">
                ...
                Get dedicated support to seamlessly integrate Hawk.js into your
