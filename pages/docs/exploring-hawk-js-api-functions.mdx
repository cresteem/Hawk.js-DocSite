...
description: "Explore Hawk.js's public API for sitemap generation, indexing strategies, and utilities. Learn how to use its methods for streamlined SEO and automation."
---
...
<ul className="keywords">
  <li>Hawk.js API</li>
  <li>sitemap generation API</li>
  <li>SEO automation API</li>
  <li>IndexNow API</li>
